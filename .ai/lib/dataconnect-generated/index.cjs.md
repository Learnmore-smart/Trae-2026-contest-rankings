# lib/dataconnect-generated/index.cjs.js

> Last updated: 2026-07-01 | Protection: STANDARD

## Purpose

CommonJS wrapper entrypoint for the local Firebase Data Connect generated Admin SDK package.

## What It Does

- Exports generated query and mutation helper functions for `require()` consumers.
...
- 2026-07-01 Codex: Implemented the CommonJS `getBoardPage` wrapper that dispatches the `GetBoardPage` query.
...
| Date | Change | Author |
|------|--------|--------|
| 2026-07-01 | Created doc for paged board CJS wrapper. | Codex |
| 2026-07-01 | Added paged board CJS wrapper. | Codex |
