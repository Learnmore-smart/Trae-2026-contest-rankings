...
export const PROMPT_VERSION = "trae-contest-2026-v7-deployment-vs-product-evidence";
...
Deployment-vs-product standard: if uploaded screenshots show a polished finished product/interface but the live demo screenshot proxy only shows an unstyled, plain-text, or otherwise broken first screen, treat that as a demo deployment/availability problem rather than proof that the product itself lacks completion or design. In that case, keep completion and design anchored to the finished screenshot evidence and other verified materials; do not cap the score solely because the live demo deployment is broken.
